...
import org.rmj.stock.base.StockRequest;
import org.rmj.stock.pojo.UnitStockRequestDetail;
import org.rmj.stock.pojo.UnitStockRequestMaster;

public class XMStockRequest implements XMRecord{
    public XMStockRequest(GRider foGRider, String fsBranchCD, boolean fbWithParent){
        this.poGRider = foGRider;
        if (foGRider != null){
            this.pbWithParent = fbWithParent;
            this.psBranchCd = fsBranchCD;
            
            poControl = new StockRequest();
    ...
    public boolean saveRecord() {
        if(pnEditMode == EditMode.UNKNOWN){
            ...
            UnitStockRequestMaster loResult;
    ...
    private StockRequest poControl;
    private UnitStockRequestMaster poData;
    
    private final UnitStockRequestDetail poDetail = new UnitStockRequestDetail();
    ...
    private final String pxeModuleName = "XMStockRequest";
}
